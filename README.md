В данной задаче необходимо реализовать итератор произвольного доступа для расширения бинарного дерева поискал. Для этого в структуру `tree_node` было добавлено поле `subtree_size`.
